...
export default function Consignacion() {
  ...
  const [form, setForm] = useState({ nombre: '', telefono: '', email: '', marca: '', modelo: '', anio: '', km: '' })
  ...
  const camposAuto = [
    ...
    { name: 'anio', label: 'ANO', type: 'text', placeholder: 'Ej: 2020' },
            ...
            <div>
              {enviado ? (
                <div className="bg-zinc-900 border border-orange-500/30 p-8 text-center">
                  <p className="text-orange-500 text-4xl font-black mb-2">OK</p>
