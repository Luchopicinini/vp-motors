...
export default function Financiamiento() {
  ...
  const pasos = [
    { num: '01', titulo: 'Elige tu auto', desc: 'Navega nuestro stock y encuentra el vehÃƒÂ­culo que mÃƒÂ¡s te gusta.' },
    { num: '02', titulo: 'Simula tu cuota', desc: 'Usa la calculadora para estimar tu cuota mensual segÃƒÂºn tu pie y plazo.' },
    { num: '03', titulo: 'ContÃƒÂ¡ctanos', desc: 'Nuestro equipo te asesora y gestiona el crÃƒÂ©dito con los mejores bancos.' },
    { num: '04', titulo: 'Maneja tu auto', desc: 'Aprobado el crÃƒÂ©dito, coordinamos la entrega rÃƒÂ¡pida con toda la documentaciÃƒÂ³n al dÃƒÂ­a.' },
  ]
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <FadeIn>
          <div className="mb-12">
            ...
            <p className="text-gray-500 mt-3 max-w-xl">Calcula tu cuota mensual estimada y consulta con nuestro equipo para conseguir el mejor crÃƒÂ©dito del mercado.</p>
          </div>
        </FadeIn>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <FadeIn delay={0.2}>
            <div className="space-y-6">
              ...
              <div>
                <label className="text-orange-500 text-xs tracking-widest font-bold block mb-2">PIE Ã¢â‚¬â€ {porcentajePie}% del precio (mÃƒÂ­nimo 20%)</label>
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-500 text-sm">$</span>
              ...
              <div className="bg-orange-500/5 border border-orange-500/20 p-4">
                ...
                <p className="text-zinc-400 text-xs leading-relaxed">Este cÃƒÂ¡lculo es solo referencial con una tasa mÃƒÂ­nima del 1,85% mensual y pie mÃƒÂ­nimo del 20%. La cuota real depende del banco, tu perfil crediticio y las condiciones vigentes. Consulta con nuestro equipo para una simulaciÃƒÂ³n oficial.</p>
              </div>
            </div>
          </FadeIn>
          ...
          <FadeIn delay={0.3}>
            <div className="flex flex-col gap-6">
              <h2 className="text-white font-black text-xl">CÃƒâ€œMO FUNCIONA</h2>
        ...
        <FadeIn delay={0.4}>
          <div className="mt-16">
            <div className="border border-zinc-800 bg-zinc-900/50 rounded-2xl p-12 text-center">
              <h2 className="text-4xl font-black tracking-tighter text-white mb-3">Ã‚Â¿Listo para <span className="text-orange-500">comenzar?</span></h2>
              <p className="text-gray-500 mb-8">ContÃƒÂ¡ctanos y descubre la diferencia</p>
