        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <FadeIn delay={0.1}>
            <div>
              ...
              {auto.imagenes.length > 10 && <p className="text-gray-600 text-xs mt-2">+{auto.imagenes.length - 10} fotos mas</p>}
            </div>
          </FadeIn>
          ...
          <FadeIn delay={0.2}>
            <div className="flex flex-col gap-4">
              ...
              <div className="border-t border-zinc-800 pt-4">
                <p className="text-orange-500 text-xs tracking-widest font-bold mb-2">DESCRIPCION</p>
      ...
      {lightbox && (
        <div className="fixed inset-0 z-50 bg-black/95 flex flex-col" onClick={() => setLightbox(false)}>
          <div className="flex items-center justify-between px-4 py-3 border-b border-zinc-800">
            ...
            <button onClick={() => setLightbox(false)} className="text-white hover:text-orange-500 text-2xl transition-all">X</button>
          </div>
