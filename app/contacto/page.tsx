...
export default function Contacto() {
  ...
  const campos = [{ name: 'nombre', label: 'NOMBRE', type: 'text', placeholder: 'Tu nombre' },{ name: 'email', label: 'EMAIL', type: 'email', placeholder: 'tu@email.com' },{ name: 'telefono', label: 'TELEFONO', type: 'tel', placeholder: '+56 9 ...' }]
  const info = [{ label: 'WHATSAPP', valor: '+56 9 1234 5678' },{ label: 'EMAIL', valor: 'contacto@vpmotors.cl' },{ label: 'DIRECCION', valor: 'Av. Camino Los Trapenses 2140' },{ label: 'HORARIO', valor: 'Lun - Sab: 9:00 - 19:00' }]
  return (
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="space-y-8">
            ...
            <a href="https://wa.me/56912345678" target="_blank" rel="noopener noreferrer" className="inline-block bg-orange-500 hover:bg-orange-600 text-black font-black text-sm px-8 py-4 tracking-widest transition-all">ESCRIBIR POR WHATSAPP</a>
          </div>
          <div>
            {enviado ? (
