...
export default function Contacto() {
  ...
  const campos = [
    ...
    { name: 'telefono', label: 'TELÃƒâ€°FONO', type: 'tel', placeholder: '+56 9 ...' }
  ]
  const info = [
    { label: 'WHATSAPP', valor: '+56 9 7489 1078' },
    { label: 'EMAIL', valor: 'contacto@vpmotors.cl' },
    { label: 'DIRECCIÃƒâ€œN', valor: 'Av. Camino Los Trapenses 2140 - Oficina 304-1.' }
  ]
  return (
        ...
        <FadeIn delay={0.2}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              <p className="text-gray-400 text-lg leading-relaxed">Ã‚Â¿Tienes dudas sobre algÃƒÂºn vehÃƒÂ­culo? Ã‚Â¿Quieres agendar una visita? ContÃƒÂ¡ctanos y te respondemos a la brevedad.</p>
            ...
            <div>
              {enviado ? (
                <div className="bg-zinc-900 border border-orange-500/30 p-8 text-center">
                  <p className="text-orange-500 text-4xl font-black mb-2">Ã¢Å“â€œ</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea name="mensaje" placeholder="Ã‚Â¿En quÃƒÂ© te podemos ayudar?" onChange={handleChange} required rows={4} className="w-full bg-zinc-900 border border-zinc-700 focus:border-orange-500 text-white px-4 py-3 text-sm outline-none transition-all placeholder:text-zinc-600 resize-none" />
                  </div>
        ...
        <FadeIn delay={0.4}>
          <div className="mt-16">
            <div className="flex items-center justify-between mb-4">
              <span className="text-orange-500 text-xs tracking-widest font-bold">CÃƒâ€œMO LLEGAR</span>
              <a href="https://maps.app.goo.gl/JfxcpUUTp8CfKjjz5" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-orange-500 text-xs tracking-widest transition-all">ABRIR EN GOOGLE MAPS Ã¢â€ â€™</a>
            </div>
