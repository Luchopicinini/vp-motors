...
export default function Contacto() {
  ...
  const info = [
    ...
    { label: 'DIRECCIÓN', valor: 'Av. Camino Los Trapenses 2140 - Oficina 304-1.' }
  ]
  return (
        ...
        <FadeIn delay={0.2}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              <p className="text-gray-400 text-lg leading-relaxed">¿Tienes dudas sobre algún vehículo? ¿Quieres agendar una visita? Contáctanos y te respondemos a la brevedad.</p>
              ...
              {enviado ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea name="mensaje" placeholder="¿En qué te podemos ayudar?" onChange={handleChange} required rows={4} className="w-full bg-zinc-900 border border-zinc-700 focus:border-orange-500 text-white px-4 py-3 text-sm outline-none transition-all placeholder:text-zinc-600 resize-none" />
                  </div>
